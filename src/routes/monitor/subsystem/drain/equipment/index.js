...
const DrainEquipment = ({ location, dispatch, drainEquipment }) => {
  const { numbers, modalVisible, modalType } = drainEquipment
...
DrainEquipment.propTypes = {
  drainEquipment: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
  // loading: PropTypes.object,
}

export default connect(({ drainEquipment}) => ({ drainEquipment}))(DrainEquipment)
