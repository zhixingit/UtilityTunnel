...
function MonitorDrain({monitorDrain}) {
  const { numbers,numberplcs} = monitorDrain
...
MonitorDrain.propTypes = {
  monitorDrain: PropTypes.object,
}

export default connect(({monitorDrain}) => ({monitorDrain}))(MonitorDrain)
