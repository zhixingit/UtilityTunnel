...
const SecurityEquipment = ({ location, dispatch, securityEquipment }) => {
  const { numbers, modalVisible, modalType } = securityEquipment
  ...
  const filterProps = {
    ...
    onSearch (fieldsValue) {
      fieldsValue.keyword.length ? dispatch(routerRedux.push({
        pathname: '/monitor/subsystem/drain/equipmentManage',
        query: {
...
SecurityEquipment.propTypes = {
  securityEquipment: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
  // loading: PropTypes.object,
}

export default connect(({ securityEquipment}) => ({ securityEquipment}))(SecurityEquipment)
