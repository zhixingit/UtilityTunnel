...
function MonitorSecurity({monitorSecurity}) {
  const { numbers,numberplcs} = monitorSecurity
...
MonitorSecurity.propTypes = {
  monitorSecurity: PropTypes.object,
}

export default connect(({monitorSecurity}) => ({monitorSecurity}))(MonitorSecurity)
