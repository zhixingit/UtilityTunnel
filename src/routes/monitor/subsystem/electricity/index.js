...
function MonitorElectricity({monitorElectricity}) {
  const { numbers,numberplcs} = monitorElectricity
...
MonitorElectricity.propTypes = {
  monitorElectricity: PropTypes.object,
}

export default connect(({monitorElectricity}) => ({monitorElectricity}))(MonitorElectricity)
