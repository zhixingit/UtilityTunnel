...
const IlluminationEquipment = ({ location, dispatch, illuminationEquipment }) => {
  const { numbers, modalVisible, modalType } = illuminationEquipment
  ...
  const filterProps = {
    ...
    onSearch (fieldsValue) {
      fieldsValue.keyword.length ? dispatch(routerRedux.push({
        pathname: '/monitor/subsystem/illumination/equipmentManage',
        query: {
...
IlluminationEquipment.propTypes = {
  illuminationEquipment: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
  // loading: PropTypes.object,
}

export default connect(({ illuminationEquipment}) => ({ illuminationEquipment}))(IlluminationEquipment)
