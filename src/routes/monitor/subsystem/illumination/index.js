...
function MonitorIllumination({monitorIllumination}) {
  const { numbers,numberplcs} = monitorIllumination
...
MonitorIllumination.propTypes = {
  monitorIllumination: PropTypes.object,
}

export default connect(({monitorIllumination}) => ({monitorIllumination}))(MonitorIllumination)
