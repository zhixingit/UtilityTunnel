...
const FireEquipment = ({ location, dispatch, fireEquipment }) => {
  const { numbers, modalVisible, modalType } = fireEquipment
  ...
  const filterProps = {
    ...
    onSearch (fieldsValue) {
      fieldsValue.keyword.length ? dispatch(routerRedux.push({
        pathname: '/monitor/subsystem/fire/equipmentManage',
        query: {
...
FireEquipment.propTypes = {
  fireEquipment: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
  // loading: PropTypes.object,
}

export default connect(({ fireEquipment}) => ({ fireEquipment}))(FireEquipment)
