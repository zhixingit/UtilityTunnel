...
function MonitorFire({monitorFire}) {
  const { numbers,numberplcs} = monitorFire
...
MonitorFire.propTypes = {
  monitorFire: PropTypes.object,
}

export default connect(({monitorFire}) => ({monitorFire}))(MonitorFire)
