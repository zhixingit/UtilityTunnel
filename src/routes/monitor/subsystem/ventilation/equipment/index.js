...
const VentilationEquipment = ({ location, dispatch, ventilationEquipment }) => {
  const { numbers, modalVisible, modalType } = ventilationEquipment
  ...
  const filterProps = {
    ...
    onSearch (fieldsValue) {
      fieldsValue.keyword.length ? dispatch(routerRedux.push({
        pathname: '/monitor/subsystem/ventilation/equipmentManage',
        query: {
...
VentilationEquipment.propTypes = {
  ventilationEquipment: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
  // loading: PropTypes.object,
}

export default connect(({ ventilationEquipment}) => ({ ventilationEquipment}))(VentilationEquipment)
